...
<body>
	...
	<form action="respon.php" method="post" enctype="multipart/form-data">
		<div class="col-sm-6" style="margin:auto;">
      <h1 align="center">POSTULER A L'EVENEMENT</h1>
      <div class="mb-3">
      ...
      include '../connexion.php';
        // mysqli_select_db($con, 'demo');
         if(isset($_GET['file_id'])){
          $id=$_GET['file_id'];
          $stmt=$db->prepare("SELECT titre from evenement Where id=$id");
          $stmt->execute();
...
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">inserer votre preuve de reservation</label>
  <input type="file" class="form-control" name="file" id="file" placeholder="insert reservation">
</div>
<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">inserer votre preuve de cheque ou virement</label>
  <input type="file" class="form-control" name="file1" id="file1" placeholder="insert cheque/virement">
</div>
<div class="mb-3">
