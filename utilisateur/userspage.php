...
<nav class="navbar bg-light fixed-top">
  <div class="container-fluid">
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          <li class="nav-item">
            <button class="btn btn-outline-success"><a class="nav-link" href="addinfo1.php">INFORMATION</a></button>
          </li>
           <li class="nav-item">
           <form action="../logout.php" class="d-flex mt-3" role="search">
    ...
    <span><button class="btn btn-outline"><a class="nav-link" href="userspage.php">BTS AMICALE</a></button></span>
      ...
      <span class="action_btn">
              <form >
                <?php 
                   if($row['fr']=="fr|pj"){
                ?>
             <button type="submit" class="btn btn-outline-success"><a class="az" href="reponsep.php?file_id=<?php echo $row['id']    ?>">formulaire</a></button>
             <button type="submit" class="btn btn-outline-success"><a class="az" href="visprime.php?file_id=<?php echo $row['id']    ?>">pj</a></button>
               <?php
             }
               else if($row['fr']=="fr|"){
               ?>
...
<?php
 ...
 include '../connexion.php';
        // mysqli_select_db($con, 'demo');
       // $dati=date_default_timezone_set('Africa/Tunis');
        $datii=date('Y-m-d');
        //echo $datii;
...
<a href="evenement.php?file_id=<?php echo $row['id']    ?>" class="e">
...
arrow_downward
             ...
             <span class="action_btn">
              <form >
             <button type="submit" class="btn btn-outline-success"><a class="az" href="reponseev.php?file_id=<?php echo $row['id']    ?>">Postuler</a></button>
