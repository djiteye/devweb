...
<body>
	...
	<form action="oper1.php" method="post" >
		<div class="col-sm-6" style="margin:auto;" class="i">
	<div class="mb-3">
...
<div class="mb-3">
  ...
  <button class="btn btn-outline-danger"><a class="e" href="addinfo.php">annuler</a></button>
</div>
</div>
