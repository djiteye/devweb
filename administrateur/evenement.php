...
include '../connecter.php';
 ...
 if(file_exists($filePath)){
        ...
        ?>
        <h1> </h1>
        <embed type="application/pdf" src="../file/<?php echo $file['file']  ?>" width="80%" height="500px"></embed>
      </br></br>
         <?php
        ...
        // mysqli_select_db($con, 'demo');
         ...
         <textarea class="form-control" id="commentaire" name="commentaire" rows="3"><?php echo $row['commentaire']    ?></textarea>
              ...
              <form >
             <button type="submit" class="btn btn-outline-success"><a class="az" href="listPE.php?file_id=<?php echo $row['id']    ?>">les postulants à: <?php echo $row['titre'] ?></a></button>
</form>
</span>
